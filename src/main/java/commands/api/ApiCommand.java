...
import datautil.ApiResponse;
import datautil.APIUtil;
import datautil.Endpoint;
import datautil.JsonUtil;
    ...
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event) {
        ...
        if (!user.isColeaderOrHigher()) {
            event.replyEmbeds(MessageUtil.buildEmbed("API",
                "Du musst mindestens Vize-Anführer eines Clubs sein, um diesen Befehl auszuführen.",
