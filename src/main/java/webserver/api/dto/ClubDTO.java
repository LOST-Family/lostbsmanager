...
/**
 * Data Transfer Object for Club in REST API
 */
public class ClubDTO {
    ...
    public ClubDTO(Club club) {
        ...
        try {
            this.index = club.getIndex();
        } catch (Exception e) {
            this.index = null;
        }

        try {
            this.nameDB = club.getNameDB();
        } catch (Exception e) {
            this.nameDB = null;
        }
        ...
        try {
            this.description = club.getDescriptionDB();
        } catch (Exception e) {
            this.description = null;
        }

        try {
            this.maxKickpoints = club.getMaxKickpoints();
        } catch (Exception e) {
        ...
        try {
            this.kickpointsExpireAfterDays = club.getDaysKickpointsExpireAfter();
        } catch (Exception e) {
            this.kickpointsExpireAfterDays = null;
        }

        try {
            ArrayList<datawrapper.KickpointReason> reasons = club.getKickpointReasons();
            if (reasons != null) {
    ...
    // badgeUrl removed (not used in lostbsmanager)
